...
import { createUrl } from './concerns';
...
<template>
    ...
    <div v-else-if="fileType(file) === FILETYPES.PDF" :class="cn(defaultStyle, 'flex items-center justify-center rounded-sm bg-rose-500 text-white')">
