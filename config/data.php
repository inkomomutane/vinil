...
return [
     ...
     */
    'date_format' => [DATE_ATOM, 'Y-m-d', 'd/m/Y', 'Y-m-d H:i:s', 'd/m/Y H:i:s', 'Y-m-d\TH:i:s.v\Z', 'Y-m-d\TH:i:s.u\Z', 'Y-m-d\TH:i:s.uP', 'Y-m-d\TH:i:s.uO', 'Y-m-d\TH:i:s.uO', 'Y-m-d\TH:i:s.uO'],
